          ...
          <nav class="dope-navbar justify-content-between" id="dopeNav">
            ...
            <div class="dope-menu" :class="flag2?'menu-on':''">
              ...
              <div class="myinfo" v-if="menu === 'breakpoint-on'">
                <img v-lazy="'https://i.loli.net/2018/12/12/5c10cd6859af9.jpg'" alt="学姐" title="“蕴藏着如此强大可能性的你，现实中却是如此的脆弱卑微得让人心痛，我的胸口就感到像被撕裂了一样。想要臣服于未来的王。但同时，又想要保护你，包容你。这样截然相反的感情不断地膨胀，等注意到的时候，眼中就只有你了。陷入了恋爱之中。”">
